...
app.delete("/users/:id", requirePermission("users:delete"), requireOwnership, deleteUser);
```
...
async function confirmMfaEnrollment(userId: string, token: string): Promise<boolean> {
