...
function logAuthorizationFailure(userId: string, resource: string, action: string): void {
  securityLogger.warn({
...
function logSuspiciousActivity(type: string, details: Record<string, unknown>): void {
  securityLogger.warn({
