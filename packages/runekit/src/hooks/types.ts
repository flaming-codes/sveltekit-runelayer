...
export type AfterChangeHook = (ctx: HookContext & { doc: Record<string, unknown> }) => Promise<void> | void;
...
export type AfterReadHook = (ctx: HookContext & { doc: Record<string, unknown> }) => Promise<Record<string, unknown>>;
