...
export const textarea = (opts: Opts<TextareaField> = {}): TextareaField => ({ type: 'textarea', ...opts });
export const number = (opts: Opts<NumberField> = {}): NumberField => ({ type: 'number', ...opts });
export const richText = (opts: Opts<RichTextField> = {}): RichTextField => ({ type: 'richText', ...opts });
export const select = (opts: Opts<SelectField>): SelectField => ({ type: 'select', ...opts });
export const multiSelect = (opts: Opts<MultiSelectField>): MultiSelectField => ({ type: 'multiSelect', ...opts });
export const checkbox = (opts: Opts<CheckboxField> = {}): CheckboxField => ({ type: 'checkbox', ...opts });
export const date = (opts: Opts<DateField> = {}): DateField => ({ type: 'date', ...opts });
export const relationship = (opts: Opts<RelationshipField>): RelationshipField => ({ type: 'relationship', ...opts });
...
export const collapsible = (opts: Omit<CollapsibleField, 'type'>): CollapsibleField => ({ type: 'collapsible', ...opts });
