...
- **better-sqlite3 native module** is auto-checked before `pnpm dev` and rebuilt on ABI mismatch. Manual fallback: `pnpm --filter @flaming-codes/sveltekit-runelayer rebuild better-sqlite3`
